...
const PROTOTYPES = [
  ...
  },
  {
    ...
    description: 'Governance Hub Dịch Vụ Công MoMo: search bar auto-suggest, Smart Checklist Generator (3 câu hỏi → checklist hồ sơ), portfolio 8 mảng BU, top 10 TTHC theo search volume, social proof và App CTA.',
    jtbd: 'Biết thủ tục cần gì, chuẩn bị đủ hồ sơ, nộp phí online qua MoMo',
    northStar: 'MEU Utility (Web) + MAU % New to services (App)',
    loop: 'Search TTHC → Governance Hub → Checklist → CTA → App MoMo → Transaction',
    hypothesis: 'Smart DVC Checklist Generator (Interactive Tool) ở First Fold sẽ tăng W2A Conversion Rate ít nhất 30% so với trang thuần text.',
    value: 'Capture 5M+ searches/tháng DVC — kênh acquisition organic cost thấp nhất cho segment có purchase intent cao nhất. Không fintech nào đang serve intent này.',
    gate: 'Đo checklist completion rate, search-to-action, service page CTR, W2A conversion và MEU Utility baseline.',
    src: 'demos/dich-vu-cong.html',
    address: 'web-momo-prototype.vercel.app/dich-vu-cong',
    tools: [
      {id:'dvc-doi-gplx',name:'Đổi Bằng Lái Xe',category:'TTHC',description:'Checklist hồ sơ + quy trình + lệ phí đổi GPLX theo 3 tình trạng: hết hạn, mất, đổi PET.',jtbd:'Biết cần chuẩn bị gì để đổi bằng lái không phải đi lại',src:'demos/doi-bang-lai-xe.html'},
      {id:'dvc-cccd',name:'CCCD',category:'TTHC',description:'Gia hạn, cấp lại, thay đổi thông tin CCCD — checklist + deadline + lệ phí.',jtbd:'Làm đúng thủ tục CCCD ngay lần đầu',src:'demos/gia-han-cccd.html'},
      {id:'dvc-ho-chieu',name:'Hộ Chiếu',category:'TTHC',description:'Cấp mới và gia hạn hộ chiếu — hồ sơ, lệ phí, thời gian xử lý.',jtbd:'Có hộ chiếu đúng hạn cho chuyến đi sắp tới',src:'demos/lam-ho-chieu.html'},
      {id:'dvc-khai-sinh',name:'Khai Sinh',category:'TTHC',description:'Đăng ký khai sinh trong hạn / quá hạn — giấy tờ cần thiết và nơi nộp.',jtbd:'Đăng ký khai sinh cho con đúng thời hạn',src:'demos/dang-ky-khai-sinh.html'},
      {id:'dvc-ket-hon',name:'Kết Hôn',category:'TTHC',description:'Thủ tục đăng ký kết hôn trong nước và có yếu tố nước ngoài.',jtbd:'Chuẩn bị đủ giấy tờ kết hôn không sai sót',src:'demos/dang-ky-ket-hon.html'},
      {id:'dvc-thue',name:'Thuế TNCN',category:'TTHC',description:'Quyết toán thuế hàng năm và khai thuế tạm nộp hàng quý.',jtbd:'Nộp thuế đúng hạn, không bị phạt chậm nộp'},
    ],
  },
  {
