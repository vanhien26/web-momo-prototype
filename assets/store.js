...
const PROTOTYPES = [
  ...
  },
  {
    ...
    category: 'MoSpark',
    maturity: 'Interactive',
    description: 'Blog publisher với pre-publish gate: viết bài → chấm điểm SEO (traditional search) và GEO (generative AI search) theo 20 tiêu chí → pass mới cho xuất bản, fail thì quay lại chỉnh với highlight rõ điểm yếu.',
    jtbd: 'Xuất bản bài viết đạt chuẩn SEO + AI search từ lần đầu',
    northStar: 'Publish gate pass rate',
    loop: 'Write → Score → Fix → Publish',
    hypothesis: 'Hard gate chặn xuất bản khi chưa đạt ngưỡng SEO/GEO sẽ nâng chất lượng nội dung trung bình và giảm effort re-optimize sau khi đã live.',
    value: 'Tạo tiêu chuẩn nội dung có thể đo được cho MoMo Blog, đảm bảo mỗi bài đều sẵn sàng cho cả Google index và AI search citation.',
    gate: 'Đo pass rate lần đầu, số lần re-submit trung bình, điểm SEO/GEO phân phối và category nào thường fail nhất.',
