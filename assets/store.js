...
const PROTOTYPES = [
  ...
  },
  {
    ...
    address: 'prototype.momo.vn/analytics',
  },
  {
    id: 'search',
  ...
  },
  {
    ...
    category: 'Identity',
    maturity: 'Interactive',
    description: 'Luồng xác minh danh tính 4 bước cho người dùng hiện tại: thông tin cá nhân → upload CCCD → selfie → review. Mô phỏng OCR auto-fill, liveness check và processing animation.',
    jtbd: 'Nâng cấp tài khoản Tier 2 nhanh, dễ hiểu, không cần ra quầy',
    northStar: 'KYC completion rate',
    loop: 'Fill → Upload → Selfie → Submit',
    hypothesis: 'Luồng KYC step-by-step rõ ràng giúp giảm drop-off và tăng completion rate so với form dài truyền thống.',
    value: 'Tăng tỷ lệ tài khoản Tier 2, mở khoá giới hạn giao dịch cao hơn và giảm chi phí onboarding offline.',
    gate: 'Đo step drop-off rate, OCR auto-fill adoption, liveness pass rate và time-to-complete.',
    src: 'demos/kyc.html',
