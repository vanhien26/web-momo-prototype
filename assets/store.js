...
const PROTOTYPES = [
  ...
  },
  {
    ...
    description: 'Biến search intent tài chính thành hệ widget tính toán hữu ích, dẫn người dùng đến hành động phù hợp trong hệ sinh thái MoMo.',
  ...
  },
  {
    ...
    ownerGroup: 'Cell Team',
    maturity: 'Interactive',
    description: 'Hub du lịch quốc tế tích hợp vé máy bay, khách sạn, eSIM và Thanh toán QR trong một flow theo quốc gia. Cho phép user lập kế hoạch và mua ngay từ web trước khi chuyển sang App MoMo.',
    jtbd: 'Lập kế hoạch và đặt mọi thứ cho chuyến đi quốc tế trong một hành trình liền mạch',
    northStar: 'Web-to-App conversion rate per destination session',
    loop: 'Country select → Tab (Flight/Hotel/eSIM/QR) → CTA → App MoMo',
    hypothesis: 'Gộp vé bay, khách sạn, eSIM và QR trong một destination hub giảm friction lập kế hoạch và tăng số lượng sản phẩm/session.',
    value: 'Acquisition surface cho Cell Team OTA + Telco: thu tín hiệu intent điểm đến và cross-sell eSIM ngay khi user đang xem vé bay.',
    gate: 'Đo destination selection, tab engagement, cross-sell click (eSIM banner), W2A deep link click rate theo từng tab.',
    src: 'demos/destination-hub.html',
    address: 'web-momo-prototype.vercel.app/destination-hub',
    tools: [
      {id:'destination-thai-lan',name:'Thái Lan Hub',category:'Child Page',description:'Trang quốc gia Thái Lan: vé bay từ Hà Nội/TP.HCM, khách sạn Bangkok/Phuket, eSIM TrueMove, thanh toán PromptPay.',jtbd:'Xem toàn bộ thông tin cần thiết cho chuyến đi Thái',src:'demos/destination-hub.html?country=thai-lan',address:'web-momo-prototype.vercel.app/destination-hub?country=thai-lan'},
      {id:'destination-singapore',name:'Singapore Hub',category:'Child Page',description:'Trang quốc gia Singapore: vé bay, khách sạn Marina Bay/Sentosa, eSIM Singtel, thanh toán NETS/PayNow.',jtbd:'Xem toàn bộ thông tin cần thiết cho chuyến đi Singapore',src:'demos/destination-hub.html?country=singapore',address:'web-momo-prototype.vercel.app/destination-hub?country=singapore'},
      {id:'destination-nhat-ban',name:'Nhật Bản Hub',category:'Child Page',description:'Trang quốc gia Nhật Bản: vé bay, khách sạn Tokyo/Osaka, eSIM NTT Docomo, thanh toán PayPay.',jtbd:'Xem toàn bộ thông tin cần thiết cho chuyến đi Nhật',src:'demos/destination-hub.html?country=nhat-ban',address:'web-momo-prototype.vercel.app/destination-hub?country=nhat-ban'},
    ],
  },
  {
    id: 'diem-den',
    name: 'Điểm Đến Du Lịch',
    category: 'Platform',
    ownerGroup: 'Cell Team',
    maturity: 'Interactive',
    description: 'Hub danh sách điểm đến quốc tế — filter theo khu vực, tìm kiếm theo tên, hiển thị giá vé bay từ, cities phổ biến. Entry point của toàn bộ travel funnel.',
    jtbd: 'Khám phá và chọn điểm đến phù hợp cho chuyến đi quốc tế',
    northStar: 'Destination selection rate → Click-through sang country hub',
    loop: 'Browse → Filter/Search → Country card → Destination Hub',
    hypothesis: 'Hub điểm đến theo khu vực giúp user có intent rộng thu hẹp lựa chọn nhanh hơn, tăng tỷ lệ tiếp tục sang đặt vé.',
    value: 'Top-of-funnel acquisition: thu tín hiệu intent điểm đến từ organic search và chuyển về country hub.',
    gate: 'Đo filter usage, search query, country card click-through rate theo từng điểm đến.',
  ...
  },
  {
    ...
    ownerGroup: 'Cell Team',
    maturity: 'Interactive',
    description: 'Trang tìm kiếm và danh sách vé máy bay quốc tế. Search form khứ hồi/một chiều, filter hãng bay/điểm dừng/giá, flight card với thông tin đầy đủ và CTA đặt vé qua App.',
    jtbd: 'So sánh và tìm vé máy bay phù hợp nhất cho chuyến đi quốc tế',
    northStar: 'Flight search → W2A click-through rate',
    loop: 'Search form → Filter → Flight cards → Đặt ngay → App MoMo',
    hypothesis: 'Giao diện tìm vé đủ chi tiết (hãng, giờ, loại hành lý) cho phép user ra quyết định ngay trên web trước khi chuyển sang App.',
    value: 'Acquisition surface cho Cell Team OTA: thu intent flight từ SEO và chuyển sang giao dịch.',
    gate: 'Đo search intent (origin/destination/date), flight card view, filter usage, W2A click.',
    src: 'demos/ve-may-bay.html',
    address: 'web-momo-prototype.vercel.app/ve-may-bay',
  },
  {
    id: 'khach-san',
    name: 'Khách Sạn',
    ...
    ownerGroup: 'Cell Team',
    maturity: 'Interactive',
    description: 'Trang tìm kiếm và listing khách sạn quốc tế. Filter sao/giá/tiện ích, city tabs, hotel card đầy đủ (ảnh, rating, giá/đêm), combo banner vé bay + khách sạn.',
    jtbd: 'Tìm và đặt khách sạn phù hợp tại điểm đến quốc tế',
    northStar: 'Hotel search → W2A click-through rate, combo bundle rate',
    loop: 'Search → City tab → Filter → Hotel card → Đặt phòng → App MoMo',
    hypothesis: 'Combo banner vé bay + khách sạn tăng bundle rate và giá trị giao dịch trung bình của Cell Team OTA.',
    value: 'Acquisition surface cho Cell Team OTA: thu intent hotel từ SEO và cross-sell với vé bay.',
    gate: 'Đo search intent, city tab engagement, combo banner click, hotel card W2A click.',
    src: 'demos/khach-san.html',
    address: 'web-momo-prototype.vercel.app/khach-san',
  },
  {
    id: 'ty-gia',
    ...
    ownerGroup: 'Cell Team',
    maturity: 'Interactive',
    description: 'PLG utility: quy đổi ngoại tệ thời gian thực, bảng tỷ giá 8 đồng tiền, so sánh phí MoMo QR (0%) vs thẻ tín dụng (3.5%). Công cụ giáo dục và acquisition cho QR Roaming.',
    jtbd: 'Biết tỷ giá thực tế và tiết kiệm bao nhiêu khi dùng MoMo thay vì thẻ tín dụng ở nước ngoài',
    northStar: 'DLU (Daily tool user), QR Roaming activation rate từ calculator',
    loop: 'Calculator → Compare savings → Kích hoạt QR → App MoMo',
    hypothesis: 'Hiển thị rõ mức tiết kiệm cụ thể (350,000đ / 10 triệu chi tiêu) thuyết phục user kích hoạt QR Quốc tế trước chuyến đi.',
    value: 'Anti-LLM moat: tool tạo unique data (tỷ giá live) không scrape được, tăng GEO citation và PLG acquisition.',
    gate: 'Đo calculator interaction, currency pair selection, savings display view, W2A click rate.',
    src: 'demos/ty-gia.html',
    address: 'web-momo-prototype.vercel.app/ty-gia',
  },
  {
    id: 'thanh-toan-quoc-te',
    name: 'Thanh Toán QR Quốc Tế',
    category: 'Platform',
    ownerGroup: 'Cell Team',
    maturity: 'Interactive',
    description: 'Hướng dẫn QR Roaming theo quốc gia: PromptPay (Thái), NETS/PayNow (Singapore), PayPay (Nhật), Kakao Pay (Hàn). Tab chọn quốc gia, step-by-step guide, venue list, coverage map 12 quốc gia.',
    jtbd: 'Hiểu cách dùng QR MoMo thanh toán tại điểm đến quốc tế và kích hoạt trước khi đi',
    northStar: 'QR Roaming activation rate, W2A click từ country guide',
    loop: 'Country tab → Steps guide → Venues → Kích hoạt QR → App MoMo',
    hypothesis: 'Guide theo quốc gia cụ thể (hệ thống QR, điểm chấp nhận, step-by-step) giảm rào cản kích hoạt QR Roaming trước chuyến đi.',
    value: 'SEO acquisition cho queries "thanh toán QR [quốc gia]" + cross-sell với eSIM và vé bay trong funnel du lịch.',
    gate: 'Đo country tab selection, step guide scroll depth, activation CTA click rate.',
    src: 'demos/thanh-toan-quoc-te.html',
    address: 'web-momo-prototype.vercel.app/thanh-toan-quoc-te',
  },
  {
    id: 'merchant',
    name: 'Merchant',
...
const GROUP_ITEM_ORDER = {
  ...
  Platform: ['phat-nguoi', 'esim-du-lich', 'diem-den', 'destination-hub', 've-may-bay', 'khach-san', 'ty-gia', 'thanh-toan-quoc-te', 'cinema', 'dich-vu-cong', 'news', 'blog-category', 'merchant'],
