...
const PROTOTYPES = [
  ...
  },
  {
    ...
    tools: [
      ...
      {
        id: 'bao-hiem-tinh-huong-chi-tiet',
        name: 'Chi Tiết Tình Huống',
        category: 'Content Page',
        description: 'Trang standalone cho từng tình huống bồi thường: quy trình yêu cầu, nhà bảo hiểm chi trả, điều khoản loại trừ và form báo giá inline. URL: ?id=collision, ?id=thuykick...',
        jtbd: 'Hiểu rõ một tình huống cụ thể và xem ngay báo giá phù hợp',
        src: 'demos/bao-hiem-tinh-huong-chi-tiet.html?id=collision',
        address: 'web-momo-prototype.vercel.app/bao-hiem-tinh-huong-chi-tiet?id=collision',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    ownerGroup: 'Cell Team',
    maturity: 'Interactive',
    description: 'Trang tổng hợp địa điểm du lịch Việt Nam và quốc tế bằng bộ icon landmark monoline tím, có search và filter theo nhóm điểm đến.',
    jtbd: 'Duyệt nhanh điểm đến phù hợp cho chuyến đi trong nước hoặc nước ngoài',
    src: 'demos/dia-diem-du-lich.html',
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        ownerGroup: 'Cell Team',
        maturity: 'Detail Page',
        description: 'Trang phim bộ/series (e.g. /cinema/series/the-last-of-us) — hero backdrop, TMDB sync dữ liệu series, season tabs, episode list với still thumbnails, streaming platform CTA + MoMo payment; không dùng điểm MoMo.',
        jtbd: 'Xem thông tin series, chọn season/tập và được dẫn đến nền tảng streaming với ưu đãi MoMo',
        northStar: 'Platform subscription via MoMo',
        loop: 'Series detail → Season select → Episode → Platform CTA → MoMo Pay',
      ...
      },
      {
        ...
        description: 'Trang listing diễn viên nổi bật (/cinema/actors) — featured strip, filter VN/Quốc tế/Đang chiếu, actor grid với stats.',
        jtbd: 'Khám phá diễn viên đang có phim, lọc theo quốc tịch hoặc trạng thái chiếu',
        northStar: 'Actor card click → Actor detail page → Film card → Đặt vé',
        loop: 'Browse listing → click actor → Actor detail → Known For → Film detail → Đặt vé',
        hypothesis: 'Listing page diễn viên tạo SEO entry point cho query "diễn viên Việt Nam 2025", "phim Scarlett Johansson đang chiếu" — supplement cho film-centric pages.',
        value: 'SEO: actor-discovery queries, cross-link với Film detail và Director pages.',
        gate: 'Filter usage, actor card CTR, featured strip CTR.',
        src: 'demos/cinema-actors.html',
        address: 'web-momo-prototype.vercel.app/cinema/actors',
      },
      {
        id: 'cinema-genre',
        name: 'Thể loại phim',
      ...
      },
      {
        ...
        ownerGroup: 'Cell Team',
        maturity: 'SEO Page',
        description: 'Standalone page /cinema/dang-chieu — danh sách đầy đủ 26+ phim đang chiếu với filter genre/format/date, sort (Phổ biến/MoMo Score/Doanh thu/Mới nhất), box office sidebar.',
        jtbd: 'Tìm phim đang chiếu hôm nay, lọc theo thể loại và format ưa thích',
        northStar: 'Film card click → ticket purchase',
        loop: 'Search "phim đang chiếu" → Listing → Filter → Film detail → Đặt vé',
      ...
      {
        id: 'cinema-coming-soon',
        name: 'Phim Sắp Chiếu',
        category: 'Listing Page',
        ownerGroup: 'Cell Team',
        maturity: 'SEO Page',
        description: 'Standalone page /cinema/sap-chieu — lịch ra rạp phim sắp chiếu theo tháng với countdown timer, notify system, "Được chờ đợi nhất" sidebar và genre filter dark theme.',
        jtbd: 'Xem phim nào sắp ra rạp, đăng ký nhận thông báo khi mở bán vé',
        northStar: 'Notify registration → ticket presale conversion',
        loop: 'Search "phim sắp chiếu 2026" → Listing → Notify → Mở bán → Đặt vé',
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        category: 'Child Page',
        src: 'demos/tram-sac.html',
        address: 'web-momo-prototype.vercel.app/tram-sac',
        description: 'EV charging station finder: split map + list, filter đầu cắm CCS2/Type2AC, tốc độ ultrafast/fast/slow, mạng V-Green/EVN/EVME/Eon. Pin màu theo trạng thái (xanh/cam/đỏ). Detail panel: port rows, session cost estimator, MoMo pay CTA.',
      },
      {
        id: 'dang-kiem',
...
const GROUP_SUMMARY = {
  ...
  Other: {
    eyebrow: 'Other',
    title: 'Other',
    description: 'Prototype thử nghiệm, asset library và concept khác.',
    examples: 'MoMo Service Icons · World Cup 2026 Predictor',
  },
  Platform: {
    eyebrow: 'PLG Project',
    title: 'PLG Project',
