...
const PROTOTYPES = [
  ...
  },
  {
    ...
    tools: [
      {id:'dvc-doi-gplx',name:'Đổi Bằng Lái Xe',category:'TTHC',description:'Checklist hồ sơ + quy trình + lệ phí đổi GPLX theo 3 tình trạng: hết hạn, mất, đổi PET.',jtbd:'Biết cần chuẩn bị gì để đổi bằng lái không phải đi lại'},
      {id:'dvc-cccd',name:'CCCD',category:'TTHC',description:'Gia hạn, cấp lại, thay đổi thông tin CCCD — checklist + deadline + lệ phí.',jtbd:'Làm đúng thủ tục CCCD ngay lần đầu'},
      {id:'dvc-ho-chieu',name:'Hộ Chiếu',category:'TTHC',description:'Cấp mới và gia hạn hộ chiếu — hồ sơ, lệ phí, thời gian xử lý.',jtbd:'Có hộ chiếu đúng hạn cho chuyến đi sắp tới'},
      {id:'dvc-khai-sinh',name:'Khai Sinh',category:'TTHC',description:'Đăng ký khai sinh trong hạn / quá hạn — giấy tờ cần thiết và nơi nộp.',jtbd:'Đăng ký khai sinh cho con đúng thời hạn'},
      {id:'dvc-ket-hon',name:'Kết Hôn',category:'TTHC',description:'Thủ tục đăng ký kết hôn trong nước và có yếu tố nước ngoài.',jtbd:'Chuẩn bị đủ giấy tờ kết hôn không sai sót'},
