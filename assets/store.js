...
const PROTOTYPES = [
  ...
  },
  {
    ...
    tools: [
      ...
      {
        id: 'cinema-actors',
        name: 'Listing Diễn viên & Đạo diễn',
        category: 'Platform',
        ownerGroup: 'Cell Team',
        maturity: 'Listing Page',
        description: 'Trang listing /cinema/person — grid diễn viên & đạo diễn, filter VN/Quốc tế, link sang person detail.',
        jtbd: 'Khám phá diễn viên đang có phim, lọc theo quốc tịch hoặc trạng thái chiếu',
        northStar: 'Person card click → Person detail → Film list → Đặt vé',
        loop: 'Browse listing → click person → Person detail → Film card → Đặt vé',
