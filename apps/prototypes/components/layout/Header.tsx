  ...
  return (
    <header>
      <div className="h-left">
        ...
        <div>
          <div className="h-brand-name">Prototype Lab</div>
          <div className="h-brand-sub">MoMo Web Platform · React shell</div>
        </div>
      </div>
      <span className="h-badge">LAB · PROTOTYPE STORE</span>
      <div className="h-user">
        <div className="h-avatar">WP</div>
        <span className="h-user-name">Web Platform · Prototype Store</span>
      </div>
    </header>
  );
}
