const demos = {
  financial: {
    ...
    src: 'demos/utilities-tool.html',
    address: 'prototype.momo.vn/widget-store',
    description: 'Workspace gọn cho hệ MoMo Widget đa dạng, từ utility, mô phỏng đến trải nghiệm tương tác có thể dùng ở nhiều industry.',
  ...
  seoGeoScore: {
    ...
    address: 'prototype.momo.vn/plg-project',
    description: 'Workspace HTML cho PLG Project với pre-publish gate, business context và content quality score trước khi cho xuất bản.',
